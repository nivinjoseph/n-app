...
import type { NavigationService, RawParams } from "./navigation.js";
import type { RouteInfo } from "./route-info.js";
import { ViewModel } from "./view-model.js";

const NAV_NOT_INJECTED =
    "NavigationService not injected on PageViewModel. Pages must be resolved through usePageViewModel.";
const ROUTE_NOT_INJECTED =
    "RouteInfo not injected on PageViewModel. Pages must be resolved through usePageViewModel.";

export abstract class PageViewModel<
    TParams extends Record<string, unknown> = never,
> extends ViewModel {
    public static override readonly $mobxOverrides: Record<string, unknown> = {
        _$navService: false,
        _$routeInfo: false,
    ...
    private readonly _$navService: NavigationService | null = null;
    private readonly _$routeInfo: RouteInfo | null = null;
    private _$rawPathParams: RawParams = {};
    private _$rawQueryParams: RawParams = {};
    private _$paramsApplied: boolean = false;

    protected retrieveParams(): TParams {
        if (this._$routeInfo == null) throw new Error(ROUTE_NOT_INJECTED);
    ...
    public goTo(path: string, options?: { replace?: boolean }): void {
        if (this._$navService == null) throw new Error(NAV_NOT_INJECTED);
